...
class YFinanceTools:
    def __init__(
        ...
        self.stock_price = stock_price or enable_all
        self.company_info = company_info or enable_all
        self.stock_fundamentals = stock_fundamentals or enable_all
        self.income_statements = income_statements or enable_all
        self.key_financial_ratios = key_financial_ratios or enable_all
        self.analyst_recommendations = analyst_recommendations or enable_all
        self.company_news = company_news or enable_all
        self.historical_prices = historical_prices or enable_all
    ...
    def get_historical_stock_prices(self, symbol: str, period: str = "1mo", interval: str = "1d", end_date: str = None) -> str:
        ...
        Args:
            ...
            end_date (str): The end date from which to retrieve historical prices.
